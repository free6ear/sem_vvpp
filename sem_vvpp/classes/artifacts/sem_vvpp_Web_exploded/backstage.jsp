                ...
                <ul class="nav" id="tab">
                    <li class="list">
                        ...
                        <div class="collapse" id="paperManagement" aria-expanded="false">
                            <ul class="nav">
                                <li id="editPaper"><a href="#/editPaper" style="font-size: 18px">编辑论文</a></li>
                                <li id="addPaper"><a href="#/addPaper" style="font-size: 18px">新增论文</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="list">
                        ...
                        <div class="collapse" id="carouselManagement" aria-expanded="false">
                            <ul class="nav">
                                <li id="editCarousel"><a href="#/editCarousel" style="font-size: 18px">编辑轮播图</a></li>
                    ...
                    <div class="col-xs-offset-3 col-xs-6" id="addPaperContent" style="margin-top: 5px">
                        <form role="form"  style="font-size: 18px">
                            <div class="form-group">
                                ...
                                <label for="name">论文标题：</label>
                                <input type="text" class="form-control" id="paperTitle" placeholder="请输入论文标题">
                            </div>
                            <div class="form-group">
                                <!-- <i class="glyphicon glyphicon-user" style="color: grey; font-size: 25px"></i> -->
                                <label for="name">论文作者：</label>
                                <input type="text" class="form-control" id="paperAuthor" placeholder="请输入论文作者">
                            </div>
                            <div class="form-group">
                                <label for="inputfile">论文文件：</label>
                                <input id="input-paper" name="paperFile" multiple type="file" data-show-caption="true">
                            </div>
                        </form>     
                    </div>
                    <!--新增轮播图-->
                    ...
                    <div class="col-xs-12" id="editCarouselContent">
                        <table class="table table-hover" style="margin-top: -17px; margin-bottom: 12px">
                            <tbody style="margin-top: -5px">
                                ...
                                <tr>
                                    <td><img src="./imgs/carousel_pic2.jpg" width="120px"></td>
                                    <td>东南汽车降税优惠至高3万&nbsp;&nbsp;2019款东南DX3预售价6.39万起</td>
                                    <td>
                                        <a href="#" id="edit">
                                            <i class="glyphicon glyphicon-edit"></i>
                                        </a>
                                ...
                                <tr>
                                    <td><img src="./imgs/carousel_pic3.jpg" width="120px"></td>
                                    <td>造物志&nbsp;&nbsp;“翼”见钟情的背后，翼设计与鹰志故事</td>
                                    <td>
                                        <a href="#" id="edit">
                                            <i class="glyphicon glyphicon-edit"></i>
                                        </a>
                                ...
                                <tr>
                                    <td><img src="./imgs/carousel_pic4.jpg" width="120px"></td>
                                    <td>响应“一带一路”&nbsp;拓展海外市场&nbsp;&nbsp;庆祝东南汽车缅甸曼德勒展厅开业</td>
                                    <td>
                                        <a href="#" id="edit">
                                            <i class="glyphicon glyphicon-edit"></i>
                                        </a>
                                ...
                                <tr>
                                    <td><img src="./imgs/carousel_pic5.png" width="120px"></td>
                                    <td>东南汽车：省钱虽是硬道理&nbsp;&nbsp;但靠谱才是真正的让利于民</td>
                                    <td>
                                        <a href="#" id="edit">
                                            <i class="glyphicon glyphicon-edit"></i>
                                        </a>
